import{ah as _,r as E,af as y,ai as D,c as R}from"./index-B0VQveaP.js";import{S as w,E as f}from"./graphql-BhlZu-4f.js";import{g as u}from"./_plugin-vue_export-helper-C58nmRBO.js";const M=_("matches",()=>{const s=E([]),h=E(!1),o=E(null);return{matches:s,loading:h,error:o,setMatches:e=>{s.value=e},addMatch:e=>{s.value.push(e)},updateMatch:e=>{const d=s.value.findIndex(l=>l.id===e.id);d!==-1&&(s.value[d]=e)},deleteMatch:e=>{s.value=s.value.filter(d=>d.id!==e)},getLiveMatches:()=>s.value.filter(e=>e.status===w.InProgress),getUpcomingMatches:()=>s.value.filter(e=>e.status===w.Scheduled),getFinishedMatches:()=>s.value.filter(e=>e.status===w.Completed)}}),L=u`
