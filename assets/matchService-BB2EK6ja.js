import{a8 as _,r as E,a7 as y,a9 as D,d as R}from"./index-Dy41vZeH.js";import{S as w,E as f}from"./graphql-BhlZu-4f.js";import{g as u}from"./index-hDARhCzz.js";const M=_("matches",()=>{const s=E([]),h=E(!1),o=E(null);return{matches:s,loading:h,error:o,setMatches:e=>{s.value=e},addMatch:e=>{s.value.push(e)},updateMatch:e=>{const d=s.value.findIndex(l=>l.id===e.id);d!==-1&&(s.value[d]=e)},deleteMatch:e=>{s.value=s.value.filter(d=>d.id!==e)},getLiveMatches:()=>s.value.filter(e=>e.status===w.InProgress),getUpcomingMatches:()=>s.value.filter(e=>e.status===w.Scheduled),getFinishedMatches:()=>s.value.filter(e=>e.status===w.Completed)}}),L=u`
