...
namespace Norskball.Migrations
{
    ...
    [Migration("20250324085710_AddLineup")]
    partial class AddLineup
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LineupMatchPlayer", b =>
                {
            ...
            modelBuilder.Entity("LineupMatchPlayer", b =>
                {
                    b.HasOne("Norskball.Models.Lineup", null)
                        .WithMany()
                        .HasForeignKey("LineupId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Norskball.Models.MatchPlayer", null)
                        .WithMany()
